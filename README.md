...
| --- | --- | --- | --- |
| 1 | [Prepare](/Docs/Install-1_Prepare.md) | 30 mins | Low effort but this can take time depending on your org complexity to collect all pre-requisites (privileges, licenses)
| 2 | [Install the Power Platform Solution](/Docs/Install-2_Solution.md) | 30 mins | Quite strait forward, few connections and environment variables to configure
| 3 | [Deploy & Configure PowerBI Report ](/Docs/Install-3_PBI.md) | 30 mins | Upload the report, configure parameters and connections, link the report to the Power App. 
